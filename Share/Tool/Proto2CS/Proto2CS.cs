    ...
    public static class InnerProto2CS
    {
        ...
        public static void Proto2CS()
        {
            ...
            foreach (string s in list)
            {
                ...
                ProtoFile2CS(fileName, protoName, cs, startOpcode, s);
            }
        }

        public static void ProtoFile2CS(string fileName, string protoName, string cs, int startOpcode, string path)
        {
            const string ns = "ET";
            msgOpcode.Clear();
