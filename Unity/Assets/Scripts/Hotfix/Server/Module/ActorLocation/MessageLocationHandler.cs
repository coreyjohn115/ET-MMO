...
namespace ET.Server
{
    ...
    [EnableClass]
    public abstract class MessageLocationHandler<E, Request, Response>: IMHandler where E : Entity where Request : MessageObject, ILocationRequest
            where Response : MessageObject, ILocationResponse
    {
        ...
        public async ETTask Handle(Entity entity, Address fromAddress, MessageObject actorMessage)
        {
            try
            {
                ...
                {
                    await unit.GetComponent<PacketComponent>().SyncPacket();
                }
