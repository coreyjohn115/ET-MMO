...
namespace ET.Client
{
    ...
    public class Joystick: MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        protected Vector2 ScreenPointToAnchoredPosition(Vector2 screenPosition)
        {
            ...
            Vector2 sizeDelta = this.baseRect.sizeDelta;
            Vector2 pivotOffset = this.baseRect.pivot * sizeDelta;
            return localPoint - (this.background.anchorMax * sizeDelta) + pivotOffset;
