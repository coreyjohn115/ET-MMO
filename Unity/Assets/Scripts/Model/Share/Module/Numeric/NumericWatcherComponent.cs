        ...
        public void Awake()
        {
            ...
            foreach (Type type in types)
            {
                ...
                foreach (object attr in attrs)
                {
                    ...
                    if (!allWatchers.TryGetValue(numericWatcherAttribute.NumericType, out List<NumericWatcherInfo> value))
                    {
                        value = new List<NumericWatcherInfo>();
                        this.allWatchers.Add(numericWatcherAttribute.NumericType, value);
                    }

                    value.Add(numericWatcherInfo);
                }
            }
        }
