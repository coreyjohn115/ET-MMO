...
public partial class ActivityConfig
{
    ...
    {
        if (this.proto != default)
        {
            return this.proto;
        }

        this.proto = ActivityCfgProto.Create();
        this.proto.Id = this.Id;
        this.proto.ActivityType = this.ActivityType;
        this.proto.Name = this.Name;
        this.proto.Desc = this.Desc;
        this.proto.Icon = this.Icon;
        this.proto.HelpId = this.HelpId;
        this.proto.WindowId = this.WindowId;
        this.proto.Args = this.Args.ToList();
        this.proto.ShowItemList = this.ShowItemList;
        this.proto.Ext = this.Ext.ToList();
        return this.proto;
    }
