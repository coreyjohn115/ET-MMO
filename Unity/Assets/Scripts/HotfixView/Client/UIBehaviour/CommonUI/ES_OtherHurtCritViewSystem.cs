...
namespace ET.Client
{
    [EntitySystemOf(typeof (ES_OtherHurtCrit))]
    [FriendOf(typeof (ES_OtherHurtCrit))]
    public static partial class ES_OtherHurtCritSystem
    {
        [EntitySystem]
        private static void Awake(this ES_OtherHurtCrit self, Transform transform)
        {
        ...
        [EntitySystem]
        private static void Destroy(this ES_OtherHurtCrit self)
        {
        ...
        public static void Initliaze(this ES_OtherHurtCrit self, long caster, HurtProto proto)
        {
            ...
            Tweener scaleL = self.E_TextText.rectTransform.DOScale(1, 0.24f, 0.4f).SetEase(Ease.OutQuad);
            ...
            Tweener scaleR = self.E_TextText.rectTransform.DOScale(1, 0.24f, 0.4f).SetEase(Ease.OutQuad);
        ...
        private static void OnPlay(this ES_OtherHurtCrit self, Tweener tweener)
        {
        ...
        private static void OnUpdate(this ES_OtherHurtCrit self, Tweener tweener)
        {
            Vector2 pos = Vector2.one;
            UIHelper.WorldToUI(self.startWorldPos, ref pos);
            (self.uiTransform as RectTransform).anchoredPosition = pos;
        ...
        private static void OnComplete(this ES_OtherHurtCrit self, Tweener tweener)
        {
            tweener?.Reset();
            self.Dispose();
        }

        public static void Play(this ES_OtherHurtCrit self)
        {
