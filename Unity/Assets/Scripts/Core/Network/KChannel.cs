...
namespace ET
{
    public class KChannel: AChannel
    {
        ...
        private const int MaxKcpMessageSize = 10 * 1024;
        ...
        private void Connect(uint timeNow)
        {
            try
            {
                ...
                {
                    Log.Error(
                        $"kChannel connect timeout: {this.Id} {this.RemoteConn} {timeNow} {this.CreateTime} {this.ChannelType} {this.RemoteAddress}");
